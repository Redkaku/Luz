...
class Luz extends GLJPanel implements GLEventListener, KeyListener {
    ...
    final float position2[] = {lightX2, lightY2, lightZ2, 1.0f};
    //                                R    G    B    A
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl.glClearColor(1.0f, 0.50f, 1.0f, 1.0f); // set background (clear) color
        ...
        g2.glClearDepth(1.0f);      // set clear depth value to farthest
        g2.glEnable(GL_DEPTH_TEST); // enables depth testing
        g2.glDepthFunc(GL_LEQUAL);  // the type of depth test to do

        g2.glShadeModel(GL_SMOOTH); // blends colors nicely, and smoothes out lighting  
        
        
        // Alguna luz de ambiente global.
        gl.glLightModelfv(GL2.GL_LIGHT_MODEL_AMBIENT, this.ambient, 0);
        g2.glLightModelfv(GL2.GL_LIGHT_MODEL_AMBIENT, this.ambient, 0);

        // First Switch the lights on.
        gl.glEnable(GL2.GL_LIGHTING);
        g2.glEnable(GL2.GL_LIGHTING);
        ...
        g2.glLightfv(GL2.GL_LIGHT1, GL2.GL_DIFFUSE, colorWhite, 0);
        g2.glLightfv(GL2.GL_LIGHT1, GL2.GL_SPECULAR, colorWhite, 0);
        g2.glLightfv(GL2.GL_LIGHT1, GL2.GL_POSITION, position2, 0);

        this.initPosition(gl, g2);

        glu = new GLU();                        // get GL Utilities
        glut = new GLUT();
    }

    public void initPosition(GL2 gl, GL2 g2) {
        float posLight1[] = {lightX, lightY, lightZ, 1.0f};
        float posLight2[] = {lightX2, lightY2, lightZ2, 1.0f};
        float spotDirection1[] = {0.0f, -1.f, 0.f};
        gl.glLightfv(GL2.GL_LIGHT0, GL2.GL_POSITION, posLight1, 0);
        g2.glLightfv(GL2.GL_LIGHT1, GL2.GL_POSITION, posLight2, 0);
    }
    ...
    public void animate(GL2 gl, GLU glu, GLUT glut, GL2 g2) {
        float posLight0[] = {lightX, lightY, lightZ, 1.f};
        gl.glLightfv(GL2.GL_LIGHT0, GL2.GL_POSITION, posLight0, 0);
        float posLight3[] = {lightX2, lightY2, lightZ2, 1.f};
        g2.glLightfv(GL2.GL_LIGHT1, GL2.GL_POSITION, posLight3, 0);
        drawLight(gl, glu, glut, g2);
        //lightX += 0.003f;
        //lightY += 0.003f;
    }

    /////////////// Define Material /////////////////////
    public void setLightSphereMaterial(GL2 gl, int face, GL2 g2) {
        //color de la esfera
        ...
        gl.glMaterialfv(face, GL2.GL_EMISSION, colorWhite, 0);

        g2.glMaterialfv(face, GL2.GL_AMBIENT, colorRed, 0);
        g2.glMaterialfv(face, GL2.GL_DIFFUSE, colorRed, 0);
        g2.glMaterialfv(face, GL2.GL_SPECULAR, colorRed, 0);
        g2.glMateriali(face, GL2.GL_SHININESS, 100);
        g2.glMaterialfv(face, GL2.GL_EMISSION, colorRed, 0);
    ...
    public void drawLight(GL2 gl, GLU glu, GLUT glut, GL2 g2) {
        setLightSphereMaterial(gl, GL.GL_FRONT, g2);
        ...
        g2.glPushMatrix();
        {
            g2.glTranslatef(lightX2, lightY2, lightZ2);
            //glut.glutSolidSphere(0.1f, 20, 20);
...
//        gl.glPushMatrix();
//        {
//            gl.glTranslatef(lightX2, lightY2, lightZ2);
//
//            //glut.glutSolidSphere(0.1f, 20, 20);
//            glut.glutSolidCube(1);
//
...
//    }
    ...
    public void display(GLAutoDrawable glad) {
        ...
        GL2 g2 = glad.getGL().getGL2();
        gl.glMatrixMode(GL_PROJECTION);  // choose projection matrix
        gl.glLoadIdentity();

        g2.glMatrixMode(GL_PROJECTION);  // choose projection matrix
        g2.glLoadIdentity();
        ...
        g2.glMatrixMode(GL_MODELVIEW);
        g2.glLoadIdentity();  // reset the model-view matrix
        ...
        g2.glTranslatef(1f, 0.5f, -1f);
        this.drawFigure(gl, glut);

        this.animate(gl, this.glu, this.glut, g2);
    ...
    public void reshape(GLAutoDrawable glad, int x, int y, int width, int height) {
        ...
        g2.glViewport(0, 0, width, height);
